...
class Rectangle:
    ...
    def __init__(self, width: int = 0, height: int = 0):
        ...
        Args:
            - width: width of the triangle in form of python integer data structure.
            - height: height of the triangle in form of python integer data structure.
        """
    ...
    def perimeter(self) -> int:
        ...
        width: int = self._width if self._height > 0 else 0
        height: int = self._height if self.width > 0 else 0
